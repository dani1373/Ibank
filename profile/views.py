...
def home_page(request, user):
    home_page_data = [
        ...
        {'role': 'Bank Admin', 'name': _('Loan report'), 'href': '/modir/loan_report'},
        ...
        {'role': 'Branch Admin', 'name': _('Loan report'), 'href': '/modir/loan_report'},
        ...
        {'role': 'Cashier', 'name': _('Profile transaction report'), 'href': '/transaction/profile_report'},
        ...
        {'role': 'Auditor', 'name': _('Auditor report'), 'href': '/transaction/auditor_report'},
